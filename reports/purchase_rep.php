...
<body onLoad="call_ajax('../ajax_call/get_purchaseRep','', 'get_purchaseRep')">
<?php echo $cm->loader() ?>
...
<section class="content-header" style="border-bottom:1px solid;padding-bottom: 14px;">
  ...
  <h2 style="text-align:center;display:block;margin:0px;padding:10px 0px;font-style:italic;background:#cdcccc;"><span class="main-heading">Purchase Report</span></h2>
<div class="panel panel-default">
  ...
  <form id="serchForm">
   ...
   <div class="col-md-1">
    <div class="form-group">
     <button type="button" class="btn btn-sm btn-primary" onClick="call_ajax('../ajax_call/get_purchaseRep','serchForm', 'get_purchaseRep')"><i class="fa fa-search"></i> Search</button>
    </div>
   </div> 
   <div class="col-md-1">
    <div class="form-group">
  ...
  <table class="table table-bordered table-striped">
    ...
    <tbody class="get_purchaseRep"></tbody>
    </table>
  </div>
</div>
<!--panel panel-default-->
