...
<body onLoad="call_ajax('ajax_call/get_area_pro_rep','', 'get_area_pro_rep')">
<?php echo $cm->loader() ?>
...
<section class="content-header" style="border-bottom:1px solid;padding-bottom: 14px;">
  ...
  Area Wise Product Reports</span></h2>
<div class="panel panel-default">
  ...
  <form id="serchForm">
   ...
   <div class="col-md-3">
    <div class="form-group">
     <select class="form-control input-sm select2" name="area_name">
   ...
   <div class="col-md-1">
    <div class="form-group">
     <button type="button" class="btn btn-sm btn-primary" onClick="call_ajax('ajax_call/get_area_pro_rep','serchForm', 'get_area_pro_rep')"><i class="fa fa-search"></i> Search</button>
    </div>
   </div> 
   <div class="col-md-1">
    <div class="form-group">
  ...
  <table class="table table-bordered table-striped">
    ...
    <tbody class="get_area_pro_rep"></tbody>
    </table>
  </div>
</div>
<!--panel panel-default-->
