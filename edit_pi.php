...
{
	$id=$_GET['id'];
	$result=$cm->selectData("purchase_invoice", "p_id=".$id."");
      ...
      <div class="modal-dialog"> 
        ...
        <div class="col-sm-12">
          <div class="alert alert-success alert-dismissable">
            ...
            Opration Successfull.............  
            <a href="purchaseList" type="button" class="btn btn-primary">Ok</a>
            </div>
        </div>
      </div>
    </div>
...
<div class="panel panel-default">
  ...
  <form id="form">
      <div class="col-md-3">
        <div class="form-group">
          ...
          <select class="form-control input-sm select2" name="vendor_id">
            ...
            <?php echo $cm->all_vendors($row['vendor_id']); ?>
            </select>
        </div>
       </div>
        <!-- col-lg-2-->
        <div class="col-md-2">
          <div class="form-group">
            <label>Date</label>
            <input type="text" name="purchase_date" class="form-control input-sm date" 
            value="<?php if(!empty($row['purchase_date'])) echo $row['purchase_date']; else  echo $cm->today(); ?>">
          </div>
        </div>
        <!-- col-lg-2-->
   ...
   <?php  $i=0;
   $p_result=$cm->selectData("stock_details", "pi_id=".$id."");
   ...
   <div class="col-md-2">
     <div class="form-group">
       <label>Rate</label>
       <input type="number" name="rate[]" value="<?php echo $pRow['rate'] ?>" class="form-control input-sm rate" 
   ...
   <div class="col-md-1">
     <div class="form-group">
       <label>Qty</label>
       <input type="text" name="qty[]" class="form-control input-sm qty" value="<?php echo $pRow['qty'] ?>" placeholder="Qty">
     </div>
   </div>
   <!--col-md-1-->
   <div class="col-md-2">
     <div class="form-group">
       <label>Total</label>
       <input type="text" name="total[]" class="form-control input-sm total" value="<?php echo $pRow['total'] ?>" placeholder="Total">
     </div>
   </div>
   <!--col-md-2-->
   <?php if($i==1){ ?>
   ...
   <div class="form-group">
    ...
    <div class="col-md-4 row">
    <input type="text" name="gst" class="row form-control input-sm" id="gst" value="<?php echo $row['gst'] ?>">
    </div>
    </div>
   </div>-->
   <!--col-md-6-->
   ...
   <div class="form-group">
    ...
    <div class="col-md-4 row">
    <input type="text" name="net_total" class="row form-control input-sm" id="net_total" value="<?php echo $row['net_total'] ?>" readonly>
    </div>
    </div>
   </div>
   <!--col-md-6-->
   ...
   <div class="form-group">
    ...
    <div class="col-md-4 row">
    <input type="text" name="paid" class="row form-control input-sm" id="receive" value="<?php echo $row['paid'] ?>">
    </div>
   ...
   <div class="form-group">
    ...
    value="<?php echo $row['net_total']-$row['paid'] ?>">
    </div>
    </div>
   </div>
   <!--col-md-6-->
   ...
   <div class="form-group">
    <button type="button" name="" class="btn btn-success btn-sm form-control" 
    onClick="update_purchase_invoice(<?php echo $id ?>)">Submit</button>
    </div>
   </div>
   <!--col-md-6-->
   </form>
